...
var _MEM_VRAM_PAGE1 = (*[19200]volatile.Register16)(unsafe.Pointer(uintptr(0x06000000)))

// Video memory page 2 as uint16 registers, as memory cannot be set as uint8 in GBA vram (0600:A000h)
var _MEM_VRAM_PAGE2 = (*[19200]volatile.Register16)(unsafe.Pointer(uintptr(0x0600A000)))
...
func SetPixel(x, y uint16, index uint8, frontPage bool) {
	var mem *[19200]volatile.Register16
	if frontPage {
		mem = _MEM_VRAM_PAGE1
	} else {
		mem = _MEM_VRAM_PAGE2
